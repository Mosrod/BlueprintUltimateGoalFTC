...
import static org.roadrunner.DriveConstants.MOTOR_VELO_PID;
import static org.roadrunner.DriveConstants.RUN_USING_ENCODER;
import static org.roadrunner.DriveConstants.encoderTicksToInches;
import static org.roadrunner.DriveConstants.getMotorVelocityF;
...
public class SampleMecanumDriveREV extends SampleMecanumDriveBase {
    ...
    public SampleMecanumDriveREV(HardwareMap hardwareMap) {
        ...
        leftRear = hardwareMap.get(DcMotorEx.class, LEFT_BACK_MOTOR_NAME);
        rightRear = hardwareMap.get(DcMotorEx.class, RIGHT_BACK_MOTOR_NAME);
